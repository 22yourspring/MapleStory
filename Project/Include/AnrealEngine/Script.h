...
public:
	...
	void SetValueHP(long long _SetValueHP) 
	{ 
		Object_Value_HP = _SetValueHP;

	}
	void SetValueMP(long long _SetValueMP) 
	{
		Object_Value_MP = _SetValueMP;
