...
public:
	...
	static const long long GATEKEEPER_MAX_HP;
	static const long long GATEKEEPER_MAX_MP;
...
public:
	CLONE(CGatekeeperScript);

public:
	CGatekeeperScript();
	virtual ~CGatekeeperScript();
};
