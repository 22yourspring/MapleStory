...
public:
	...
	static const long long PHANTOMWATCH_MAX_HP;
	static const long long PHANTOMWATCH_MAX_MP;
...
public:
	CLONE(CPhantomwatchScript);

public:
	CPhantomwatchScript();
	virtual ~CPhantomwatchScript();
};
